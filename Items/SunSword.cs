...
namespace HelloMod.Items
{
    ...
    public class SunSword : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            // Ingredience
            recipe.AddIngredient(ModContent.ItemType<SunstoneBar>(), 5);     // 5× Sunstone Bar
            recipe.AddIngredient(ItemID.Obsidian, 5);      // 5× Obsidian
            recipe.AddIngredient(ItemID.Hellstone, 5);      // 5x Hellstone
